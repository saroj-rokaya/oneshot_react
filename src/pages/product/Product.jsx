...
const Product = () => {
  ...
  const deleteMe = async () => {
    const response = await axios.delete('https://66dc84a947d749b72acbc6f7.mockapi.io/products/' + id);
    if(response.status===200){
      navigate("/");
    }
    else{
          ...
          <div className="flex flex-col md:flex-row -mx-4">
            <div className="md:flex-1 px-4">
              ...
              <div className="flex -mx-2 mb-4">
                ...
                <div className="w-1/2 px-2">
                  <button onClick={deleteMe} className="w-full bg-red-700 dark:bg-red-700 text-gray-800 dark:text-white py-2 px-4 rounded-full font-bold hover:bg-gray-300 dark:hover:bg-gray-600">Delete</button>
                </div>
              </div>
            </div>
            <div className="md:flex-1 px-4">
