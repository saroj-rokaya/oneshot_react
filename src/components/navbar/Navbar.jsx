...
const Navbar = () => {
    return (
        <>
            <div className="top-0 py-1 lg:py-2 w-full bg-[#1a1d2b] lg:relative z-50 dark:bg-[#1a1d2b]">
