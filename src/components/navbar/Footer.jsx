                        ...
                        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                            <div className="space-y-4">
                                ...
                                <div className="flex space-x-2">
                                    <Link to="" target="_blank" className="text-gray-200 hover:text-gray-200">
                                        <span className="sr-only">Linkedin</span><svg fill="currentColor" viewBox="0 0 24 24"
                                            className="h-6 w-6" ariaHidden="true">
                                ...
                                <div className="md:grid md:grid-cols-2 md:gap-8">
                                    <div>
                                        ...
                                        <ul role="list" className="mt-6 space-y-4">
                                            ...
                                            <li>
                                                <Link to="/blog" className="text-md leading-6 text-gray-300 hover:text-gray-50">Blog
                                                </Link>
                                            </li>
                                            <li>
                                                <Link to="/casestudies"
                                            ...
                                            <li>
                                                <Link to="/terms" className="text-md leading-6 text-gray-300 hover:text-gray-50">Terms
                                                    of Service
                                                </Link>
                                            </li>
                                            <li>
